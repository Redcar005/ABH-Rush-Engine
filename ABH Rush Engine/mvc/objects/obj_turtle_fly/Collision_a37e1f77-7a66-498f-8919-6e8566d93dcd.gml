if canHit && obj_Sonic.ground = false && ((collision_line(x-12, y-8, x+7, y-8, obj_Sonic, true, true) && image_xscale == 1) || (collision_line(x+12, y-8, x-7, y-8, obj_Sonic, true, true) && image_xscale == -1))
{
