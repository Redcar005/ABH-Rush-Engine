...
if time > 0
{
    ...
    if !done_button4 && button4.image_alpha < 1
        button4.image_alpha += 0.125 
    if !done_button5 && button5.image_alpha < 1
        button5.image_alpha += 0.125 
    
    if !done_button1 && !done_button2 && !done_button3 && !done_button4 && !done_button5
    {
    ...
    else if done_button1 && !done_button2 && !done_button3 && !done_button4 && !done_button5
    {
...
if !done && time > 0
{
    ...
    if done_button4 && button4.image_alpha > 0
    {
        button4.image_alpha -= 0.125
        button4.image_xscale += 0.125
        button4.image_yscale += 0.125
    }
    
    if done_button5 && button5.image_alpha > 0
    {
        button5.image_alpha -= 0.125
        button5.image_xscale += 0.125
        button5.image_yscale += 0.125
    }
}
x = x_button3
y = y_button3
