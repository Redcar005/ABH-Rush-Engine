if ((other.character == consPlayerNameSonic && (other.sprp == spr_Sonic_spinjump || other.sprp == spr_SuperSonic_spinjump)) || (other.character == consPlayerNameShadow && (other.sprp == spr_Shadow_spinjump || other.sprp == spr_SuperShadow_spinjump))) && !other.ground && !instance_exists(obj_boostfx)
{
